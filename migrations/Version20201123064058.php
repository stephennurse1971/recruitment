 ...
 */
final class Version20201123064058 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employer ADD CONSTRAINT FK_DE4CF0669D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
